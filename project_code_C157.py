...
player1.place = Label(relx = 0.1, rely = 0.3 , anchor = CENTER)

player2 = Label(root, text = "Player 2", bg = "red", fg = "white")
player2.place = Label(relx = 0.9, rely = 0.3 , anchor = CENTER)
...
pokemon_list = [pikachu,bulbasour,Iyvasour,Charmender,Squirtle,Ratata,Nidoking,Jigglypuff,Meowth,Persion,Abra,Kadabra]
power_list = [200,70,120,90,30,50,90,80,140,60,110,150]
